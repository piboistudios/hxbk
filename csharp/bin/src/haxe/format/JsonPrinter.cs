				...
				
				{
					...
					switch (_g._hx_index) {
						...
						case 2:
						{
							...
							bool v1 = (  ! (global::System.Double.IsInfinity(((double) (f) )))  &&  ! (global::System.Double.IsNaN(((double) (f) )))  );
							this.buf.b.Append(((string) (global::Std.@string(( (v1) ? (global::haxe.lang.Runtime.toString(v)) : ("null") ))) ));
							break;
						}
