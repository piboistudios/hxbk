...
namespace sys.io {
	public class File : global::haxe.lang.HxObject {
		...
		public static global::sys.io.FileOutput append(string path, global::haxe.lang.Null<bool> binary) {
			bool binary1 = ( ( ! (binary.hasValue) ) ? (true) : ((binary).@value) );
			global::System.IO.FileStream stream = new global::System.IO.FileStream(((string) (path) ), ((global::System.IO.FileMode) (global::System.IO.FileMode.Append) ), ((global::System.IO.FileAccess) (global::System.IO.FileAccess.Write) ), ((global::System.IO.FileShare) (global::System.IO.FileShare.ReadWrite) ));
			return new global::sys.io.FileOutput(((global::System.IO.FileStream) (stream) ));
		}
		...
		public static global::sys.io.FileOutput update(string path, global::haxe.lang.Null<bool> binary) {
			...
			if ( ! (global::sys.FileSystem.exists(path)) ) {
				global::sys.io.File.write(path, default(global::haxe.lang.Null<bool>)).close();
			}
			
			global::System.IO.FileStream stream = new global::System.IO.FileStream(((string) (path) ), ((global::System.IO.FileMode) (global::System.IO.FileMode.OpenOrCreate) ), ((global::System.IO.FileAccess) (global::System.IO.FileAccess.Write) ), ((global::System.IO.FileShare) (global::System.IO.FileShare.ReadWrite) ));
			return new global::sys.io.FileOutput(((global::System.IO.FileStream) (stream) ));
		}
